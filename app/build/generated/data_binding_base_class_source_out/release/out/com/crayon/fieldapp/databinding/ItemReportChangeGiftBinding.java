...
public final class ItemReportChangeGiftBinding implements ViewBinding {
  ...
  private ItemReportChangeGiftBinding(@NonNull LinearLayout rootView, @NonNull TextView txtAm,
      ...
      @NonNull TextView txtNumCustomer, @NonNull TextView txtShift, @NonNull TextView txtShiftTitle,
      @NonNull TextView txtStore, @NonNull TextView txtType, @NonNull TextView txtTypeTitle) {
  ...
  public static ItemReportChangeGiftBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txt_num_customer;
      TextView txtNumCustomer = rootView.findViewById(id);
      if (txtNumCustomer == null) {
        break missingId;
      }
      ...
      id = R.id.txt_store;
      TextView txtStore = rootView.findViewById(id);
      if (txtStore == null) {
        break missingId;
      }
      ...
      return new ItemReportChangeGiftBinding((LinearLayout) rootView, txtAm, txtDateTitle, txtName,
          txtNameTitle, txtNumCustomer, txtShift, txtShiftTitle, txtStore, txtType, txtTypeTitle);
    }
