...
public class FragmentForgotBindingImpl extends FragmentForgotBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.bn_reset, 3);
    }
    // views
    // variables
    // values
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.forgot.ForgotPasswordViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.forgot.ForgotPasswordViewModel ViewModel) {
