...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTLISTEMPLOYEE = 54;

  private static final int LAYOUT_FRAGMENTLISTGROUP = 55;

  private static final int LAYOUT_FRAGMENTLISTGROUPEMPLOYEE = 56;

  private static final int LAYOUT_FRAGMENTLISTIMAGE = 57;

  private static final int LAYOUT_FRAGMENTLISTJOBREQUEST = 58;

  private static final int LAYOUT_FRAGMENTLISTMANAGEMENTAPPLICATIONS = 59;

  private static final int LAYOUT_FRAGMENTLISTMYJOB = 60;

  private static final int LAYOUT_FRAGMENTLISTPICAPPLICATIONS = 61;

  private static final int LAYOUT_FRAGMENTLISTPICNOTIFICATION = 62;

  private static final int LAYOUT_FRAGMENTLISTPRODUCT = 63;

  private static final int LAYOUT_FRAGMENTLISTPROJECT = 64;

  private static final int LAYOUT_FRAGMENTLISTREPORTCOMPETITORATSTORE = 65;

  private static final int LAYOUT_FRAGMENTLISTREPORTSALESATSTORE = 66;

  private static final int LAYOUT_FRAGMENTLISTREPORTTRACKINGATSTORE = 67;

  private static final int LAYOUT_FRAGMENTLISTSTORE = 68;

  private static final int LAYOUT_FRAGMENTLISTUPDATESTATUSATSTORE = 69;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESH = 70;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESHTOOLBAR = 71;

  private static final int LAYOUT_FRAGMENTLOGIN = 72;

  private static final int LAYOUT_FRAGMENTMAIN = 73;

  private static final int LAYOUT_FRAGMENTMANAGEAPPLICATION = 74;

  private static final int LAYOUT_FRAGMENTMANAGEATTENDANCE = 75;

  private static final int LAYOUT_FRAGMENTMANAGECHANGEGIFT = 76;

  private static final int LAYOUT_FRAGMENTMANAGEEMPLOYEE = 77;

  private static final int LAYOUT_FRAGMENTMANAGENOTIFICATION = 78;

  private static final int LAYOUT_FRAGMENTMANAGEPROJECT = 79;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTCOMPETITOR = 80;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTSALES = 81;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTTRACKING = 82;

  private static final int LAYOUT_FRAGMENTMANAGESTORE = 83;

  private static final int LAYOUT_FRAGMENTMANAGEUPDATESTATUS = 84;

  private static final int LAYOUT_FRAGMENTMEMBERGROUPUSER = 85;

  private static final int LAYOUT_FRAGMENTMEMBERPROJECT = 86;

  private static final int LAYOUT_FRAGMENTMONITOR = 87;

  private static final int LAYOUT_FRAGMENTNOTIFICATION = 88;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONCONTAINER = 89;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONSENT = 90;

  private static final int LAYOUT_FRAGMENTPRIVACY = 91;

  private static final int LAYOUT_FRAGMENTPROFILE = 92;

  private static final int LAYOUT_FRAGMENTPROFILECONTAINER = 93;

  private static final int LAYOUT_FRAGMENTPROJECTINPROGRESS = 94;

  private static final int LAYOUT_FRAGMENTREGISTER = 95;

  private static final int LAYOUT_FRAGMENTREPORT = 96;

  private static final int LAYOUT_FRAGMENTREPORTCOMPETITOR = 97;

  private static final int LAYOUT_FRAGMENTREPORTENDSHIFT = 98;

  private static final int LAYOUT_FRAGMENTREPORTPROJECT = 99;

  private static final int LAYOUT_FRAGMENTREPORTSALES = 100;

  private static final int LAYOUT_FRAGMENTREPORTTIME = 101;

  private static final int LAYOUT_FRAGMENTREPORTUPDATESTATUS = 102;

  private static final int LAYOUT_FRAGMENTREQUIRELOGIN = 103;

  private static final int LAYOUT_FRAGMENTRESETPASSWORD = 104;

  private static final int LAYOUT_FRAGMENTSELECTPROJECT = 105;

  private static final int LAYOUT_FRAGMENTSELECTPROMOTION = 106;

  private static final int LAYOUT_FRAGMENTSPLASH = 107;

  private static final int LAYOUT_FRAGMENTSTOREPROJECT = 108;

  private static final int LAYOUT_FRAGMENTTERM = 109;

  private static final int LAYOUT_FRAGMENTVERIFYOTP = 110;

  private static final int LAYOUT_FRAGMENTVERIFYOTPSTEP2 = 111;

  private static final int LAYOUT_ITEMADDMEMBERTOPROJECT = 112;

  private static final int LAYOUT_ITEMATTENDANCE = 113;

  private static final int LAYOUT_ITEMDETAILGROUP = 114;

  private static final int LAYOUT_ITEMFILTERSTORE = 115;

  private static final int LAYOUT_ITEMGROUPSTORE = 116;

  private static final int LAYOUT_ITEMGROUPUSER = 117;

  private static final int LAYOUT_ITEMMANAGEMENTAPPLICATION = 118;

  private static final int LAYOUT_ITEMMANAGEMENTTASK = 119;

  private static final int LAYOUT_ITEMMEMBER = 120;

  private static final int LAYOUT_ITEMMEMBERREQUEST = 121;

  private static final int LAYOUT_ITEMNOTIFICATION = 122;

  private static final int LAYOUT_ITEMORDER = 123;

  private static final int LAYOUT_ITEMPICAPPLICATION = 124;

  private static final int LAYOUT_ITEMPROJECT = 125;

  private static final int LAYOUT_ITEMPROMOTION = 126;

  private static final int LAYOUT_ITEMSELECTPRODUCT = 127;

  private static final int LAYOUT_ITEMSELECTSTORE = 128;

  private static final int LAYOUT_ITEMSELECTUSER = 129;

  private static final int LAYOUT_ITEMSTORE = 130;

  private static final int LAYOUT_ITEMSTOREGROUPSTORE = 131;

  private static final int LAYOUT_ITEMSWITCHSHIFTREQUEST = 132;

  private static final int LAYOUT_ITEMTODAYJOB = 133;

  private static final int LAYOUT_ITEMUSER = 134;
  ...
  private static class InnerLayoutIdLookup {
    static final HashMap<String, Integer> sKeys = new HashMap<String, Integer>(134);
