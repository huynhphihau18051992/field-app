...
public class ItemOrderBindingImpl extends ItemOrderBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_edit, 2);
        sViewsWithIds.put(R.id.txt_name_title, 3);
        sViewsWithIds.put(R.id.txt_name, 4);
        sViewsWithIds.put(R.id.txt_quality_title, 5);
        sViewsWithIds.put(R.id.txt_quality, 6);
        sViewsWithIds.put(R.id.txt_price_title, 7);
        sViewsWithIds.put(R.id.txt_price, 8);
        sViewsWithIds.put(R.id.txt_toal_title, 9);
        sViewsWithIds.put(R.id.txt_total, 10);
        sViewsWithIds.put(R.id.txt_load_more, 11);
    }
    // views
    @NonNull
