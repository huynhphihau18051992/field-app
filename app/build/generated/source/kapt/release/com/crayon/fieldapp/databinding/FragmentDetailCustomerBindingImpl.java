...
public class FragmentDetailCustomerBindingImpl extends FragmentDetailCustomerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_page, 6);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.detailTask.changeGift.detailCustomer.DetailCustomerViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.detailTask.changeGift.detailCustomer.DetailCustomerViewModel ViewModel) {
