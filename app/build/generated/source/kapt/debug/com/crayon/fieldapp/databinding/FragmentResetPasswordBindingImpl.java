...
public class FragmentResetPasswordBindingImpl extends FragmentResetPasswordBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ic_lock_pass, 1);
        sViewsWithIds.put(R.id.edt_password, 2);
        sViewsWithIds.put(R.id.ic_lock, 3);
        sViewsWithIds.put(R.id.edt_confirm_password, 4);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.resetPassword.ResetPasswordViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.resetPassword.ResetPasswordViewModel ViewModel) {
