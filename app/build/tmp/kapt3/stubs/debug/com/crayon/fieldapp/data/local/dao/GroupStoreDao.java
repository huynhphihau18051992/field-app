...
public abstract interface GroupStoreDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM groupStore WHERE groupStore.id = :id")
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "DELETE FROM groupStore WHERE id = :id")
    public abstract java.lang.Object deleteGroup(@org.jetbrains.annotations.NotNull()
    java.lang.String id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> p1);
    
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "DELETE FROM groupStore")
    public abstract java.lang.Object deleteAll(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> p0);
    
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM groupStore LIMIT :pageSize OFFSET :pageIndex")
