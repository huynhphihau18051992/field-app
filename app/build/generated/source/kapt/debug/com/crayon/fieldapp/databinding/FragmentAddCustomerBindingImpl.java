...
public class FragmentAddCustomerBindingImpl extends FragmentAddCustomerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.stepper_indicator, 5);
        sViewsWithIds.put(R.id.pagger, 6);
    }
    // views
    @NonNull
    ...
    public FragmentAddCustomerBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentAddCustomerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
