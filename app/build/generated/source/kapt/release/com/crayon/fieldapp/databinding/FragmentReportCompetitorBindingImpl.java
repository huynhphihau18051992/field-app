...
public class FragmentReportCompetitorBindingImpl extends FragmentReportCompetitorBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_customer, 16);
    }
    // views
    @NonNull
    ...
    public FragmentReportCompetitorBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private FragmentReportCompetitorBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.detailTask.reportCompetitor.ReportCompetitorViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.detailTask.reportCompetitor.ReportCompetitorViewModel ViewModel) {
