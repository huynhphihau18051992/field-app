...
import com.crayon.fieldapp.databinding.FragmentDetailChangeGiftAtStoreBindingImpl;
...
import com.crayon.fieldapp.databinding.FragmentHistoryTrackingBindingImpl;
...
import com.crayon.fieldapp.databinding.FragmentListChangeGiftAtStoreBindingImpl;
import com.crayon.fieldapp.databinding.FragmentListCustomerBindingImpl;
import com.crayon.fieldapp.databinding.FragmentListEmployeeBindingImpl;
import com.crayon.fieldapp.databinding.FragmentListGiftBindingImpl;
...
import com.crayon.fieldapp.databinding.FragmentListPromotionBindingImpl;
...
import com.crayon.fieldapp.databinding.FragmentManageChangeGiftBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTDETAILCHANGEGIFTATSTORE = 21;

  private static final int LAYOUT_FRAGMENTDETAILCUSTOMER = 22;

  private static final int LAYOUT_FRAGMENTDETAILGROUPSTORE = 23;

  private static final int LAYOUT_FRAGMENTDETAILGROUPUSER = 24;

  private static final int LAYOUT_FRAGMENTDETAILMANAGEMENTJOB = 25;

  private static final int LAYOUT_FRAGMENTDETAILNOTIFICATION = 26;

  private static final int LAYOUT_FRAGMENTDETAILORDER = 27;

  private static final int LAYOUT_FRAGMENTDETAILPICJOB = 28;

  private static final int LAYOUT_FRAGMENTDETAILPROJECT = 29;

  private static final int LAYOUT_FRAGMENTDETAILREPORTCOMPETITORATSTORE = 30;

  private static final int LAYOUT_FRAGMENTDETAILREPORTSALESATSTORE = 31;

  private static final int LAYOUT_FRAGMENTDETAILREPORTTRACKINGATSTORE = 32;

  private static final int LAYOUT_FRAGMENTDETAILSTORE = 33;

  private static final int LAYOUT_FRAGMENTDETAILTASK = 34;

  private static final int LAYOUT_FRAGMENTDETAILTASKATTENDANCE = 35;

  private static final int LAYOUT_FRAGMENTDETAILUPDATESTATUSATSTORE = 36;

  private static final int LAYOUT_FRAGMENTDETAILUSER = 37;

  private static final int LAYOUT_FRAGMENTEXPORTGIFT = 38;

  private static final int LAYOUT_FRAGMENTFILTERJOB = 39;

  private static final int LAYOUT_FRAGMENTFORGOT = 40;

  private static final int LAYOUT_FRAGMENTHISTORYTRACKING = 41;

  private static final int LAYOUT_FRAGMENTHOME = 42;

  private static final int LAYOUT_FRAGMENTHOMECONTAINER = 43;

  private static final int LAYOUT_FRAGMENTIMPORTGIFT = 44;

  private static final int LAYOUT_FRAGMENTINFO = 45;

  private static final int LAYOUT_FRAGMENTINPUTBILL = 46;

  private static final int LAYOUT_FRAGMENTINPUTNAME = 47;

  private static final int LAYOUT_FRAGMENTJOB = 48;

  private static final int LAYOUT_FRAGMENTJOBCONTAINER = 49;

  private static final int LAYOUT_FRAGMENTJOBPROJECT = 50;

  private static final int LAYOUT_FRAGMENTLISTATTENDANCEATSTORE = 51;

  private static final int LAYOUT_FRAGMENTLISTATTRIBUTES = 52;

  private static final int LAYOUT_FRAGMENTLISTCHANGEGIFTATSTORE = 53;

  private static final int LAYOUT_FRAGMENTLISTCUSTOMER = 54;

  private static final int LAYOUT_FRAGMENTLISTEMPLOYEE = 55;

  private static final int LAYOUT_FRAGMENTLISTGIFT = 56;

  private static final int LAYOUT_FRAGMENTLISTGROUP = 57;

  private static final int LAYOUT_FRAGMENTLISTGROUPEMPLOYEE = 58;

  private static final int LAYOUT_FRAGMENTLISTIMAGE = 59;

  private static final int LAYOUT_FRAGMENTLISTJOBREQUEST = 60;

  private static final int LAYOUT_FRAGMENTLISTMANAGEMENTAPPLICATIONS = 61;

  private static final int LAYOUT_FRAGMENTLISTMYJOB = 62;

  private static final int LAYOUT_FRAGMENTLISTPICAPPLICATIONS = 63;

  private static final int LAYOUT_FRAGMENTLISTPICNOTIFICATION = 64;

  private static final int LAYOUT_FRAGMENTLISTPRODUCT = 65;

  private static final int LAYOUT_FRAGMENTLISTPROJECT = 66;

  private static final int LAYOUT_FRAGMENTLISTPROMOTION = 67;

  private static final int LAYOUT_FRAGMENTLISTREPORTCOMPETITORATSTORE = 68;

  private static final int LAYOUT_FRAGMENTLISTREPORTSALESATSTORE = 69;

  private static final int LAYOUT_FRAGMENTLISTREPORTTRACKINGATSTORE = 70;

  private static final int LAYOUT_FRAGMENTLISTSTORE = 71;

  private static final int LAYOUT_FRAGMENTLISTUPDATESTATUSATSTORE = 72;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESH = 73;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESHTOOLBAR = 74;

  private static final int LAYOUT_FRAGMENTLOGIN = 75;

  private static final int LAYOUT_FRAGMENTMAIN = 76;

  private static final int LAYOUT_FRAGMENTMANAGEAPPLICATION = 77;

  private static final int LAYOUT_FRAGMENTMANAGEATTENDANCE = 78;

  private static final int LAYOUT_FRAGMENTMANAGECHANGEGIFT = 79;

  private static final int LAYOUT_FRAGMENTMANAGEEMPLOYEE = 80;

  private static final int LAYOUT_FRAGMENTMANAGENOTIFICATION = 81;

  private static final int LAYOUT_FRAGMENTMANAGEPROJECT = 82;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTCOMPETITOR = 83;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTSALES = 84;

  private static final int LAYOUT_FRAGMENTMANAGEREPORTTRACKING = 85;

  private static final int LAYOUT_FRAGMENTMANAGESTORE = 86;

  private static final int LAYOUT_FRAGMENTMANAGEUPDATESTATUS = 87;

  private static final int LAYOUT_FRAGMENTMEMBERGROUPUSER = 88;

  private static final int LAYOUT_FRAGMENTMEMBERPROJECT = 89;

  private static final int LAYOUT_FRAGMENTMONITOR = 90;

  private static final int LAYOUT_FRAGMENTNOTIFICATION = 91;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONCONTAINER = 92;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONSENT = 93;

  private static final int LAYOUT_FRAGMENTPRIVACY = 94;

  private static final int LAYOUT_FRAGMENTPROFILE = 95;

  private static final int LAYOUT_FRAGMENTPROFILECONTAINER = 96;

  private static final int LAYOUT_FRAGMENTPROJECTINPROGRESS = 97;

  private static final int LAYOUT_FRAGMENTREGISTER = 98;

  private static final int LAYOUT_FRAGMENTREPORT = 99;

  private static final int LAYOUT_FRAGMENTREPORTCOMPETITOR = 100;

  private static final int LAYOUT_FRAGMENTREPORTENDSHIFT = 101;

  private static final int LAYOUT_FRAGMENTREPORTPROJECT = 102;

  private static final int LAYOUT_FRAGMENTREPORTSALES = 103;

  private static final int LAYOUT_FRAGMENTREPORTTIME = 104;

  private static final int LAYOUT_FRAGMENTREPORTUPDATESTATUS = 105;

  private static final int LAYOUT_FRAGMENTREQUIRELOGIN = 106;

  private static final int LAYOUT_FRAGMENTRESETPASSWORD = 107;

  private static final int LAYOUT_FRAGMENTSELECTPROJECT = 108;

  private static final int LAYOUT_FRAGMENTSELECTPROMOTION = 109;

  private static final int LAYOUT_FRAGMENTSPLASH = 110;

  private static final int LAYOUT_FRAGMENTSTOREPROJECT = 111;

  private static final int LAYOUT_FRAGMENTTERM = 112;

  private static final int LAYOUT_FRAGMENTVERIFYOTP = 113;

  private static final int LAYOUT_FRAGMENTVERIFYOTPSTEP2 = 114;

  private static final int LAYOUT_ITEMADDMEMBERTOPROJECT = 115;

  private static final int LAYOUT_ITEMATTENDANCE = 116;

  private static final int LAYOUT_ITEMDETAILGROUP = 117;

  private static final int LAYOUT_ITEMFILTERSTORE = 118;

  private static final int LAYOUT_ITEMGROUPSTORE = 119;

  private static final int LAYOUT_ITEMGROUPUSER = 120;

  private static final int LAYOUT_ITEMMANAGEMENTAPPLICATION = 121;

  private static final int LAYOUT_ITEMMANAGEMENTTASK = 122;

  private static final int LAYOUT_ITEMMEMBER = 123;

  private static final int LAYOUT_ITEMMEMBERREQUEST = 124;

  private static final int LAYOUT_ITEMNOTIFICATION = 125;

  private static final int LAYOUT_ITEMORDER = 126;

  private static final int LAYOUT_ITEMPICAPPLICATION = 127;

  private static final int LAYOUT_ITEMPROJECT = 128;

  private static final int LAYOUT_ITEMPROMOTION = 129;

  private static final int LAYOUT_ITEMSELECTPRODUCT = 130;

  private static final int LAYOUT_ITEMSELECTSTORE = 131;

  private static final int LAYOUT_ITEMSELECTUSER = 132;

  private static final int LAYOUT_ITEMSTORE = 133;

  private static final int LAYOUT_ITEMSTOREGROUPSTORE = 134;

  private static final int LAYOUT_ITEMSWITCHSHIFTREQUEST = 135;

  private static final int LAYOUT_ITEMTODAYJOB = 136;

  private static final int LAYOUT_ITEMUSER = 137;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_detail_change_gift_at_store, LAYOUT_FRAGMENTDETAILCHANGEGIFTATSTORE);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_history_tracking, LAYOUT_FRAGMENTHISTORYTRACKING);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_list_change_gift_at_store, LAYOUT_FRAGMENTLISTCHANGEGIFTATSTORE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_list_customer, LAYOUT_FRAGMENTLISTCUSTOMER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_list_employee, LAYOUT_FRAGMENTLISTEMPLOYEE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_list_gift, LAYOUT_FRAGMENTLISTGIFT);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_list_promotion, LAYOUT_FRAGMENTLISTPROMOTION);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.crayon.fieldapp.R.layout.fragment_manage_change_gift, LAYOUT_FRAGMENTMANAGECHANGEGIFT);
  ...
  private final ViewDataBinding internalGetViewDataBinding0(DataBindingComponent component,
    ...
    switch(internalId) {
      ...
      case  LAYOUT_FRAGMENTDETAILCHANGEGIFTATSTORE: {
        if ("layout/fragment_detail_change_gift_at_store_0".equals(tag)) {
          return new FragmentDetailChangeGiftAtStoreBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_detail_change_gift_at_store is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTHISTORYTRACKING: {
        if ("layout/fragment_history_tracking_0".equals(tag)) {
          return new FragmentHistoryTrackingBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_history_tracking is invalid. Received: " + tag);
      }
  ...
  private final ViewDataBinding internalGetViewDataBinding1(DataBindingComponent component,
    ...
    switch(internalId) {
      ...
      case  LAYOUT_FRAGMENTLISTCHANGEGIFTATSTORE: {
        if ("layout/fragment_list_change_gift_at_store_0".equals(tag)) {
          return new FragmentListChangeGiftAtStoreBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_list_change_gift_at_store is invalid. Received: " + tag);
      }
      case  LAYOUT_FRAGMENTLISTCUSTOMER: {
        if ("layout/fragment_list_customer_0".equals(tag)) {
          return new FragmentListCustomerBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_list_customer is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTLISTGIFT: {
        if ("layout/fragment_list_gift_0".equals(tag)) {
          return new FragmentListGiftBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_list_gift is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTLISTPROMOTION: {
        if ("layout/fragment_list_promotion_0".equals(tag)) {
          return new FragmentListPromotionBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_list_promotion is invalid. Received: " + tag);
      }
      ...
      case  LAYOUT_FRAGMENTMANAGECHANGEGIFT: {
        if ("layout/fragment_manage_change_gift_0".equals(tag)) {
          return new FragmentManageChangeGiftBindingImpl(component, view);
        }
        throw new IllegalArgumentException("The tag for fragment_manage_change_gift is invalid. Received: " + tag);
      }
  ...
  private static class InnerBrLookup {
    ...
    static {
      sKeys.put(0, "_all");
      sKeys.put(1, "item");
      sKeys.put(2, "shareViewModel");
      sKeys.put(3, "viewModel");
    }
  }

  private static class InnerLayoutIdLookup {
    static final HashMap<String, Integer> sKeys = new HashMap<String, Integer>(137);
    ...
    static {
      ...
      sKeys.put("layout/fragment_detail_change_gift_at_store_0", com.crayon.fieldapp.R.layout.fragment_detail_change_gift_at_store);
      ...
      sKeys.put("layout/fragment_history_tracking_0", com.crayon.fieldapp.R.layout.fragment_history_tracking);
      ...
      sKeys.put("layout/fragment_list_change_gift_at_store_0", com.crayon.fieldapp.R.layout.fragment_list_change_gift_at_store);
      sKeys.put("layout/fragment_list_customer_0", com.crayon.fieldapp.R.layout.fragment_list_customer);
      sKeys.put("layout/fragment_list_employee_0", com.crayon.fieldapp.R.layout.fragment_list_employee);
      sKeys.put("layout/fragment_list_gift_0", com.crayon.fieldapp.R.layout.fragment_list_gift);
      ...
      sKeys.put("layout/fragment_list_promotion_0", com.crayon.fieldapp.R.layout.fragment_list_promotion);
      ...
      sKeys.put("layout/fragment_manage_change_gift_0", com.crayon.fieldapp.R.layout.fragment_manage_change_gift);
