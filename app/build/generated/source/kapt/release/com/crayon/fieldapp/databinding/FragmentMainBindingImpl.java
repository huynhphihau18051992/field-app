...
public class FragmentMainBindingImpl extends FragmentMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.vp_dashboard, 1);
        sViewsWithIds.put(R.id.tab_dashboard, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.main.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.main.MainViewModel ViewModel) {
