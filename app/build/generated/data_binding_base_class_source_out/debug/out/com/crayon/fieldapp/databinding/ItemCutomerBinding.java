...
public final class ItemCutomerBinding implements ViewBinding {
  ...
  private ItemCutomerBinding(@NonNull LinearLayout rootView, @NonNull ImageView icUser,
      ...
      @NonNull TextView txtDateTitle, @NonNull TextView txtGift, @NonNull TextView txtGiftTitle,
      @NonNull TextView txtName, @NonNull TextView txtNameTitle, @NonNull TextView txtPhone,
      @NonNull TextView txtPhoneTitle) {
  ...
  public static ItemCutomerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txt_gift_title;
      TextView txtGiftTitle = rootView.findViewById(id);
      ...
      return new ItemCutomerBinding((LinearLayout) rootView, icUser, imgEdit, txtCustomerNum,
          txtDate, txtDateTitle, txtGift, txtGiftTitle, txtName, txtNameTitle, txtPhone,
          txtPhoneTitle);
    }
