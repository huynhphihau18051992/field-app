...
public class FragmentCalendarBindingImpl extends FragmentCalendarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_jobs, 7);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.calendar.CalendarViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.calendar.CalendarViewModel ViewModel) {
