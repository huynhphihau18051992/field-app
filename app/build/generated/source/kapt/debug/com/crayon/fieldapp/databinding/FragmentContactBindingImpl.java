...
public class FragmentContactBindingImpl extends FragmentContactBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ic_phone, 5);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.contact.ContactViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.contact.ContactViewModel ViewModel) {
