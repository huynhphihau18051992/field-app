...
public class ItemProjectBindingImpl extends ItemProjectBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_agency_name, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.crayon.fieldapp.data.remote.response.ProjectResponse) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.crayon.fieldapp.data.remote.response.ProjectResponse Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.crayon.fieldapp.data.remote.response.ProjectResponse item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.crayon.fieldapp.utils.BindingUtilsKt.setProjectInfo(this.txtInfo, item);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.txtProjectName, itemName);
        }
    }
