...
public class FragmentReportBindingImpl extends FragmentReportBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tab_timekeeping, 5);
        sViewsWithIds.put(R.id.vp_timekeeping, 6);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.report.ReportViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.report.ReportViewModel ViewModel) {
