...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTAPPLICATION = 5;

  private static final int LAYOUT_FRAGMENTAPPLICATIONAPPROVED = 6;

  private static final int LAYOUT_FRAGMENTATTENDANCE = 7;

  private static final int LAYOUT_FRAGMENTAVATAR = 8;

  private static final int LAYOUT_FRAGMENTBANK = 9;

  private static final int LAYOUT_FRAGMENTCALENDAR = 10;

  private static final int LAYOUT_FRAGMENTCHANGEGIFT = 11;

  private static final int LAYOUT_FRAGMENTCONTACT = 12;

  private static final int LAYOUT_FRAGMENTCREATEAPPLICATION = 13;

  private static final int LAYOUT_FRAGMENTCREATEJOB = 14;

  private static final int LAYOUT_FRAGMENTCREATETASK = 15;

  private static final int LAYOUT_FRAGMENTDETAILATTACHMENT = 16;

  private static final int LAYOUT_FRAGMENTDETAILATTENDANCE = 17;

  private static final int LAYOUT_FRAGMENTDETAILATTENDANCEATSTORE = 18;

  private static final int LAYOUT_FRAGMENTDETAILGROUPSTORE = 19;

  private static final int LAYOUT_FRAGMENTDETAILGROUPUSER = 20;

  private static final int LAYOUT_FRAGMENTDETAILMANAGEMENTJOB = 21;

  private static final int LAYOUT_FRAGMENTDETAILNOTIFICATION = 22;

  private static final int LAYOUT_FRAGMENTDETAILPICJOB = 23;

  private static final int LAYOUT_FRAGMENTDETAILPROJECT = 24;

  private static final int LAYOUT_FRAGMENTDETAILSTORE = 25;

  private static final int LAYOUT_FRAGMENTDETAILTASK = 26;

  private static final int LAYOUT_FRAGMENTDETAILTASKATTENDANCE = 27;

  private static final int LAYOUT_FRAGMENTDETAILUPDATESTATUSATSTORE = 28;

  private static final int LAYOUT_FRAGMENTDETAILUSER = 29;

  private static final int LAYOUT_FRAGMENTFILTERJOB = 30;

  private static final int LAYOUT_FRAGMENTFORGOT = 31;

  private static final int LAYOUT_FRAGMENTHOME = 32;

  private static final int LAYOUT_FRAGMENTHOMECONTAINER = 33;

  private static final int LAYOUT_FRAGMENTINFO = 34;

  private static final int LAYOUT_FRAGMENTINPUTBILL = 35;

  private static final int LAYOUT_FRAGMENTINPUTNAME = 36;

  private static final int LAYOUT_FRAGMENTJOB = 37;

  private static final int LAYOUT_FRAGMENTJOBCONTAINER = 38;

  private static final int LAYOUT_FRAGMENTJOBPROJECT = 39;

  private static final int LAYOUT_FRAGMENTLISTATTENDANCEATSTORE = 40;

  private static final int LAYOUT_FRAGMENTLISTATTRIBUTES = 41;

  private static final int LAYOUT_FRAGMENTLISTEMPLOYEE = 42;

  private static final int LAYOUT_FRAGMENTLISTGROUP = 43;

  private static final int LAYOUT_FRAGMENTLISTGROUPEMPLOYEE = 44;

  private static final int LAYOUT_FRAGMENTLISTIMAGE = 45;

  private static final int LAYOUT_FRAGMENTLISTJOBREQUEST = 46;

  private static final int LAYOUT_FRAGMENTLISTMANAGEMENTAPPLICATIONS = 47;

  private static final int LAYOUT_FRAGMENTLISTMYJOB = 48;

  private static final int LAYOUT_FRAGMENTLISTPICAPPLICATIONS = 49;

  private static final int LAYOUT_FRAGMENTLISTPICNOTIFICATION = 50;

  private static final int LAYOUT_FRAGMENTLISTPRODUCT = 51;

  private static final int LAYOUT_FRAGMENTLISTPROJECT = 52;

  private static final int LAYOUT_FRAGMENTLISTSTORE = 53;

  private static final int LAYOUT_FRAGMENTLISTUPDATESTATUSATSTORE = 54;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESH = 55;

  private static final int LAYOUT_FRAGMENTLOADMOREREFRESHTOOLBAR = 56;

  private static final int LAYOUT_FRAGMENTLOGIN = 57;

  private static final int LAYOUT_FRAGMENTMAIN = 58;

  private static final int LAYOUT_FRAGMENTMANAGEAPPLICATION = 59;

  private static final int LAYOUT_FRAGMENTMANAGEATTENDANCE = 60;

  private static final int LAYOUT_FRAGMENTMANAGEEMPLOYEE = 61;

  private static final int LAYOUT_FRAGMENTMANAGENOTIFICATION = 62;

  private static final int LAYOUT_FRAGMENTMANAGEPROJECT = 63;

  private static final int LAYOUT_FRAGMENTMANAGESTORE = 64;

  private static final int LAYOUT_FRAGMENTMANAGEUPDATESTATUS = 65;

  private static final int LAYOUT_FRAGMENTMEMBERGROUPUSER = 66;

  private static final int LAYOUT_FRAGMENTMEMBERPROJECT = 67;

  private static final int LAYOUT_FRAGMENTMONITOR = 68;

  private static final int LAYOUT_FRAGMENTNOTIFICATION = 69;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONCONTAINER = 70;

  private static final int LAYOUT_FRAGMENTNOTIFICATIONSENT = 71;

  private static final int LAYOUT_FRAGMENTPRIVACY = 72;

  private static final int LAYOUT_FRAGMENTPROFILE = 73;

  private static final int LAYOUT_FRAGMENTPROFILECONTAINER = 74;

  private static final int LAYOUT_FRAGMENTPROJECTINPROGRESS = 75;

  private static final int LAYOUT_FRAGMENTREGISTER = 76;

  private static final int LAYOUT_FRAGMENTREPORT = 77;

  private static final int LAYOUT_FRAGMENTREPORTENDSHIFT = 78;

  private static final int LAYOUT_FRAGMENTREPORTPROJECT = 79;

  private static final int LAYOUT_FRAGMENTREPORTTIME = 80;

  private static final int LAYOUT_FRAGMENTREPORTUPDATESTATUS = 81;

  private static final int LAYOUT_FRAGMENTREQUIRELOGIN = 82;

  private static final int LAYOUT_FRAGMENTRESETPASSWORD = 83;

  private static final int LAYOUT_FRAGMENTSELECTPROJECT = 84;

  private static final int LAYOUT_FRAGMENTSELECTPROMOTION = 85;

  private static final int LAYOUT_FRAGMENTSPLASH = 86;

  private static final int LAYOUT_FRAGMENTSTOREPROJECT = 87;

  private static final int LAYOUT_FRAGMENTTERM = 88;

  private static final int LAYOUT_FRAGMENTVERIFYOTP = 89;

  private static final int LAYOUT_FRAGMENTVERIFYOTPSTEP2 = 90;

  private static final int LAYOUT_ITEMADDMEMBERTOPROJECT = 91;

  private static final int LAYOUT_ITEMATTENDANCE = 92;

  private static final int LAYOUT_ITEMDETAILGROUP = 93;

  private static final int LAYOUT_ITEMFILTERSTORE = 94;

  private static final int LAYOUT_ITEMGROUPSTORE = 95;

  private static final int LAYOUT_ITEMGROUPUSER = 96;

  private static final int LAYOUT_ITEMMANAGEMENTAPPLICATION = 97;

  private static final int LAYOUT_ITEMMANAGEMENTTASK = 98;

  private static final int LAYOUT_ITEMMEMBER = 99;

  private static final int LAYOUT_ITEMMEMBERREQUEST = 100;

  private static final int LAYOUT_ITEMNOTIFICATION = 101;

  private static final int LAYOUT_ITEMPICAPPLICATION = 102;

  private static final int LAYOUT_ITEMPROJECT = 103;

  private static final int LAYOUT_ITEMSELECTSTORE = 104;

  private static final int LAYOUT_ITEMSELECTUSER = 105;

  private static final int LAYOUT_ITEMSTORE = 106;

  private static final int LAYOUT_ITEMSTOREGROUPSTORE = 107;

  private static final int LAYOUT_ITEMSWITCHSHIFTREQUEST = 108;

  private static final int LAYOUT_ITEMTODAYJOB = 109;

  private static final int LAYOUT_ITEMUSER = 110;
