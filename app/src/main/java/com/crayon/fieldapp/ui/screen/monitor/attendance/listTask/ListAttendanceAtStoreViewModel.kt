...
class ListAttendanceAtStoreViewModel(
    private val taskRepository: TaskRepository,
    private val dispatchers: AppDispatchers
) : BaseViewModel() {

    private val _tasks = MediatorLiveData<Event<Resource<List<TaskResponse>>>>()
    val tasks: LiveData<Event<Resource<List<TaskResponse>>>> get() = _tasks

    fun getTaskByProject(date: Calendar, agencyId: String, projectId: String, taskType: Int, skip: Int = 0, take: Int = 20) =
