...
public class FragmentDetailManagementJobBindingImpl extends FragmentDetailManagementJobBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.fab_create, 14);
    }
    // views
    @NonNull
    ...
    public FragmentDetailManagementJobBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private FragmentDetailManagementJobBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.crayon.fieldapp.ui.screen.detailManagementJob.DetailManagementJobViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.crayon.fieldapp.ui.screen.detailManagementJob.DetailManagementJobViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.crayon.fieldapp.ui.screen.detailManagementJob.DetailManagementJobViewModel viewModel = mViewModel;
