...
public class MonitorFragmentDirections {
  ...
  @NonNull
  public static NavDirections actionMonitorFragmentToManageReportTrackingFragment() {
    return new ActionOnlyNavDirections(R.id.action_monitorFragment_to_manageReportTrackingFragment);
  }

  @NonNull
  public static NavDirections actionMonitorFragmentToManageReportSalesFragment() {
    return new ActionOnlyNavDirections(R.id.action_monitorFragment_to_manageReportSalesFragment);
  }

  @NonNull
  public static NavDirections actionMonitorFragmentToManageReportCompetitorFragment() {
    return new ActionOnlyNavDirections(R.id.action_monitorFragment_to_manageReportCompetitorFragment);
  }
